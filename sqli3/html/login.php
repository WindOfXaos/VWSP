    ...
    <div class="row-cols-3 h-100" style="display: grid; place-items:center;">
        <form method="GET">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputUsername1" name="accid">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <input type="password" class="form-control" id="exampleInputPassword1" name="password">
            </div>
            <button type="submit" onclick="return isValid()" class="btn btn-dark" name="submit">Submit</button>
        </form>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
    <script>
        function isValid(){
            var str = document.getElementById("exampleInputUsername1").value;
...
if (isset($_GET['submit']) or (isset($_GET['accid']) and isset($_GET['password']))) {
